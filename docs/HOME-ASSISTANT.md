...
| `select` | `select.lg_tv_screensaver_mode` | Screen Saver | Which screen saver the TV runs: LG default, Clock, Starfield or Panel vitals. Brightness is set on the dashboard's Screensaver tab |
