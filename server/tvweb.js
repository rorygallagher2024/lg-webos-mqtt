...
var PAGE = [
  ...
  '      var logoVal = String(d.oled.logo_dimming).toLowerCase();',
  '      var logoText = (logoVal === "strong" ? "HIGH" : logoVal).toUpperCase();',
  '      q("oled-protect").textContent = "Orbit: " + String(d.oled.screen_shift).toUpperCase() + " · Logo: " + logoText + dimmerText;',
