...
var PAGE = [
  ...
  '    <div class="val"><span id="panelhours">-</span> <span class="val-unit">operating hours</span></div>',
  '    <div style="font-size: 13px; color: var(--dim);">Next Short Cycle in: <strong style="color: var(--accent);" id="oled-next-short">-</strong></div>',
  '  </div>',
  '  <div class="progress-bar"><div class="progress-fill" id="oledbar" style="width: 0%;"></div></div>',
  '  <div class="oled-grid">',
  '    <div class="oled-stat">',
  ...
  '      q("oled-next-short").textContent = "~" + d.oled.hours_until_comp + "h";',
  '',
  '      // Short cycle progress (0 to 4 hrs)',
  '      const shortPct = Math.min(100, (d.oled.hours_since_comp / 4) * 100);',
  '      setProgress("oledbar", shortPct, shortPct >= 95 ? "var(--amber)" : "var(--accent)");',
  '',
  '      q("oled-short").textContent = d.oled.hours_since_comp + "h ago";',
  '      q("oled-short-meta").textContent = "Due in ~" + d.oled.hours_until_comp + "h (standby)";',
  '',
